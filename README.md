...
Полностью оптимизирован для архитектур **x86_64** и **ARM** (включая **Armbian** и **Ubuntu 24.04 Noble LTS**). Подходит как для мощных Ryzen VPS, так и для одноплатных компьютеров.
...
* **Порт (Port):** Укажите один из ваших портов Reality (например, `54320`).
...
* **Reality -> Dest / Server Names:** Укажите домен-декой стороннего ресурса (например, `images.apple.com`) и ваш альтернативный домен, привязанный к этому порту.
...
* `443/UDP` — напрямую для работы Hysteria 2.
